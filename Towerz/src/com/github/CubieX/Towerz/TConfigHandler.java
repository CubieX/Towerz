...
public class TConfigHandler 
{
   private FileConfiguration config;
   private final Towerz plugin;

   public TConfigHandler(Towerz plugin) 
   {
      this.plugin = plugin;      
   ...
   public void reloadConfig(CommandSender sender)
   {
      ...
      sender.sendMessage(Towerz.logPrefix + plugin.getDescription().getName() + " " + plugin.getDescription().getVersion() + " reloaded!");      
   } 
}
